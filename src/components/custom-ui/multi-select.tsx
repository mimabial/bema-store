...
import {type ColorValues, type ProductFormValues} from "@/forms/schemas";
...
type MultiSelectProps = {
  options: ColorValues[],
  placeholder: string,
	field: ControllerRenderProps<ProductFormValues, 'colors'>,
  visibles: number,
}

export function MultiSelect({options, placeholder, field, visibles}: MultiSelectProps) {
	...
	const handleUnselect = React.useCallback((color: ColorValues) => {
		const value = selected.filter((s) => s.id !== color.id)
